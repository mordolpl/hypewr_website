document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        "pl": {
            ...
            "footer_rights": "&copy; 2025 Koło Naukowe HYPEwR.",
        ...
        "en": {
            ...
            "footer_rights": "&copy; 2025 HYPEwR Scientific Circle.",
    ...
    if (navPlaceholder) {
        ...
        <nav>
            <div class="logo">HYPE<span>wR</span></div>
            ...
            <div class="nav-container" id="navMenu">
                <div class="nav-links">
                    ...
                    <a href="${currentPath === 'index.html' ? 'pages/projekty.html' : 'projekty.html'}" class="${currentPath === 'projekty.html' ? 'active' : ''}" data-i18n="nav_projects">Projekty</a>
            ...
            <div class="footer-left">
                <div class="footer-logos">
                    <a href="https://hypewr.pwr.edu.pl/" style="text-decoration: none;">
                        <img src="../media/images/logo.png" alt="Logo HYPEwR" style="margin-right: 20px;">
                    </a>
                    <a href="https://pwr.edu.pl/" style="text-decoration: none;">
                        <img src="../media/images/pwr.png" alt="Logo PWr">
                    </a>
                </div>
                <div>
                    <p><strong>HYPEwR</strong><br><span data-i18n="footer_univ">Politechnika Wrocławska</span></p>
                </div>
            </div>
            <div class="footer-right">
                <p>kn.hypewr@pwr.edu.pl</p>
                <p style="opacity: 0.5; margin-top: 5px;" data-i18n="footer_rights">&copy; ${new Date().getFullYear()} Koło Naukowe HYPEwR.</p>
            </div>
        </footer>
        `;
    }
