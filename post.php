...
<body>
    ...
    <header class="sub-hero" style="height: 40vh; min-height: 300px; display: flex; justify-content: center; align-items: center; text-align: center; position: relative;">
        ...
        <div class="hero-content" style="z-index: 10; max-width: 800px; padding: 0 20px;">
            <h1 style="font-size: 3rem; margin-bottom: 15px; text-shadow: 0 4px 20px rgba(0,195,255,0.4);"><?= htmlspecialchars($post['title']) ?></h1>
            <div style="display: flex; justify-content: center; align-items: center; gap: 10px; color: var(--accent-primary); font-family: var(--font-head); letter-spacing: 2px; font-size: 0.9rem;">
    ...
    <article class="section" style="padding-top: 60px; padding-bottom: 80px; max-width: 900px; margin: 0 auto;">
        <div class="post-content" style="background: var(--card-bg); padding: 50px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); box-shadow: 0 10px 40px rgba(0,0,0,0.5); font-size: 1.1rem; line-height: 1.8; color: #ddd;">
            <?= $post['content'] ?>
        </div>
